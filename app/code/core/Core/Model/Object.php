 ...
 * Core object user for managing object data with fallback get/set/unset methods 
 * 
 * @package Core
 * @category Model
    ...
    */
    ...
    public function getData($key='', $index=null)
    {
        ...
        if (strpos($key,'/')) {
            ...
            foreach ($keyArr as $i=>$k) {
                ...
                if (is_array($data)) {
                    ...
                    $data = $data[$k];
                } elseif ($data instanceof Core_Model_Object) {
                    $data = $data->getData($k);
                } else {
                    return $default;
                }
        ...
        if (isset($this->_data[$key])) {
            ...
            } elseif ($value instanceof Core_Model_Object) {
    ...
    public function __call($method, $args)
    {
        ...
        die("Invalid method ".get_class($this)."::".$method."(".print_r($args,1).")");
    }
